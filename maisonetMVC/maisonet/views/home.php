...
?>
  ...
  <body>
    ...
    <div class = "menu">
  	 <img id="logo1" src="/maisonet/views/Images-accueil/logo_provisoire2.png" > </img>
    ...
    <div class = "presentation">
      <div class="card">
        <img class="imgCard" src="/maisonet/views/Images-accueil/logo_provisoire_mini.png" alt="Avatar">
        <div class="container">
      ...
      <div class="card">
        <img class="imgCard" src="/maisonet/views/Images-accueil/helpquestionmark.png" alt="Avatar">
        <div class="container">
      ...
      <div class="card">
        <img class="imgCard" src="/maisonet/views/Images-accueil/money.png" alt="Avatar">
        <div class="container">
