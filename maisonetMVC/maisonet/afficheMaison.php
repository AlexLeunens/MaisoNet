...
if (mysqli_num_rows($result) == 0) {
    ...
    while ($rowPiece = $result->fetch_assoc()) { // piece
        ...
        while ($rowCapteur = $resultCapteur->fetch_assoc()) {
            ...
            echo "<img onclick=\"toggle_visibility('capteur" . $rowCapteur["idCapteur"] . "');\" class='imagesCapteurs' src='views/user/Images-utilisateur/" . $rowCapteur["Type"] . ".png' alt='" . $rowCapteur["Type"] . "'></img>";
